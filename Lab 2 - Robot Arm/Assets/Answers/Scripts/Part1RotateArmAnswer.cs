...
public class Part1RotateArmAnswer : MonoBehaviour
{
    ...
    {   
        ...
        // The starting position of the arm is in the direction of the X (blue) arrow

        // TODO: Add a sequence of arm movement to ArmMovementList so that the arm touches the target
